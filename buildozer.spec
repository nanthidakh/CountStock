# This buildozer.spec config file tells Buildozer an app's requirements for being built.
#
...
android.permissions = android.permission.INTERNET, android.permission.VIBRATE
